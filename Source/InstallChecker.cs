...
namespace Jettison
{
    ...
    {
        private const string MODNAME = "Jettison";
        private const string FOLDERNAME = "Jettison";
        ...
        protected void Start()
        {
            ...
            if (assemblies.Any())
            {
                ...
                (
                    ...
                    new Vector2(0.5f, 0.5f),
                    "test",
                    Localizer.Format("#Jettison_InstallChecker_title", MODNAME),//"Incorrect " +  + " Installation" 
